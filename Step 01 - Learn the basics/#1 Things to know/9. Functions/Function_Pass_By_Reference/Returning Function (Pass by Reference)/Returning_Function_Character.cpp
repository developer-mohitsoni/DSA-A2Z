...
// Returning Function Pass By Reference (Returning Character)
...
int main()
{
    ...
    doSomething(ch) = 'M'; // ch ka reference return ho raha hai, toh ch = M ho jayega
