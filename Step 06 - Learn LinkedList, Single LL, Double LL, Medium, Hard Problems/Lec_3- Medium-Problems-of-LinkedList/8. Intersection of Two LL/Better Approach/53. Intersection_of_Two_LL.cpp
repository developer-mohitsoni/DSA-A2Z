//! Program to Find the Intersection of Two Linked Lists using Better Approach

#include <bits/stdc++.h>
using namespace std;

//* T.C:- O(N1*1) + O(N2*1)
//* S.C:- O(N1) where N1 is the size of the first linked list
...
Node *findIntersection(Node *head1, Node *head2)
{
  ...
  while (temp1 != nullptr)
  {
    nodeMap[temp1] = 1; // Using the node address as the key
    temp1 = temp1->next;
  }
